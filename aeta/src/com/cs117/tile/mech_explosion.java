...
public class mech_explosion implements ApplicationListener{
	...
	@Override
	public void create(){
		expSheet = new Texture(Gdx.files.internal("gfx/mechAttackExplosion.png"));
		...
		mechExpAnimation = new Animation(0.025f,expFrames);
	...
	public void render(){
		 Gdx.gl.glClear(GL10.GL_COLOR_BUFFER_BIT | GL10.GL_DEPTH_BUFFER_BIT);                        // #14
	        ...
	        currentFrame = mechExpAnimation.getKeyFrame(stateTime, true);  // #16
	        spriteBatch.begin();
